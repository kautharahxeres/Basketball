<html>
    <head>
        ...
        <style>
            ...
            background-image:url(back1.jpg); background-size:cover;}
        </style>
        <link rel="stylesheet" href="css/bootstrap.min.css">
    </head>
    <body>
        <h3 style="color:blue;">ADD THE REQUIRED INFORMATION CAREFULLY!!!</h3>
                ...
                <div class="col-lg-6">
                    <form action="Action.php" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="Benefits" class="form-control" placeholder="gains">
                        </div>
                        <div class="form-group">
