<html lang="en">
  <head>
    ...
    <title> Index .</title>
     <style>
      video{border:solid; margin-bottom:20px; border-radius:15px; background-color:}
  ...
  <body background="basket3.jpg" >
    <div class="container">
          ...
          <div class="row"style="border:solid 2px teal; border-radius:50px;background-color:olive;" >
            ...
            <div class="col-lg-4" style="border:solid 2px teal;border-radius:50px;background-color:purple;" >
            ...
            <div class="col-lg-4" style="border:solid 2px teal;border-radius:50px; background-color:lightblue;" >
          ...
          <div class="row" style="border:solid 2px teal; border-radius:50px; background-color:olive;" >
              <div class="col-lg-4"style="border:solid 2px olive;border-radius:50px;background-color:purple;">
